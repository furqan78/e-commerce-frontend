                ...
                <input
                  ...
                  {...register('password', {
                    ...
                    pattern: {
                      ...
                      message: appLevelConstant.PASSWORD_FORMAT
                    }
                  })}
                  type="password"
                  className="block w-full rounded-md border-gray-400 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
              ...
              <div className="mt-2">
                <input
                  ...
                  {...register('confirmPassword', {
                    required: appLevelConstant.CONFIRM_PASSWORD_REQUIRED,
                    validate: (value, formValues) => value === formValues.password || appLevelConstant.PASSWORD_NOT_MATCH
                  })}
                  type="password"
                  className="block w-full rounded-md border-gray-400 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                />
