            ...
            <div>
              ...
              <div className="mt-2">
                <input
                  id="password"
                  {...register('password', {
                    required: appLevelConstant.PASSWORD_REQUIRED,
                  })}
                  type="password"
                  className="block w-full rounded-md py-1.5 border-gray-400 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                />
                {errors.password ? <p className='text-red-500'>{errors.password.message}</p> : null}
                {userError ? <p className='text-red-500'>{userError.message}</p> : null}
              </div>
            </div>
