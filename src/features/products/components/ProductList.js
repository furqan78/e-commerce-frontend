        ...
        <div>
          ...
          <main className="mx-auto px-7 sm:px-6 lg:px-8">
            ...
            <section aria-labelledby="products-heading" className="pb-24 pt-6">
              <div className="">
                {/* <DesktopFilter handleFilter={handleFilter} filtersArray={filtersArray} /> */}
...
function MobileFilter({ mobileFiltersOpen, setMobileFiltersOpen, filtersArray, handleFilter }) {
  return (
    <div>
...
function DesktopFilter({ handleFilter, filtersArray }) {
  console.log(filtersArray, ' getting filters arry');
  return (
    <div>
      {/* Filters */}
...
function ProductGrid({ products }) {
  return (
    <div className="lg:col-span-3">
      <div className="bg-white">
        <div className="mx-auto px-4 py-0 sm:px-6 sm:py-0 lg:px-8">
          <div className="mt-6 product-list-grid-container">
            {products && products.data ? products.data.map((product) => (
              <Link to={`/product-detail/${product.id}`}>
                <div key={product.id} className="group relative product-grid-card">
